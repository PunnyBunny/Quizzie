            ...
            <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
              ...
              <table className="w-full text-left text-sm">
                <thead className="bg-gray-50 text-gray-500">
                  <tr>
                    <th className="px-6 py-3 font-medium">{t("adminUsers.col.user")}</th>
                    <th className="px-6 py-3 font-medium">{t("adminUsers.col.role")}</th>
                    <th className="px-6 py-3 font-medium">{t("adminUsers.col.status")}</th>
